...
<head>
   ...
   <!--Made with love by Mutiullah Samim -->
	...
	<!--Custom styles-->
	<link rel="stylesheet" type="text/css" href="css/register2css.css">
</head>
<body>
	<div class="container">
		<div class="d-flex justify-content-center h-100">
			...
			<div class="card-body">
	<form action="controladorregistro2.php" method="POST">
		...
		<div class="input-group form-group">
			<div class="input-group-prepend">
				...
				<input required="true" type="EMAIL" name="email" class="form-control" placeholder="email">
		...
		<div class="input-group form-group">
			<div class="input-group-prepend">
				...
				<input required="true" type="password" name="pass2" class="form-control" placeholder="repeat password">
		</div>
